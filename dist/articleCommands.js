...
该设置会用于各种发文模式；顺序发文、随机连续发文和难度发文按字数计算，随机抽行（乱序）按行数计算。数量必须是 10～2000 的整数。
...
会使用当前的文章、模式和段落长度重新发文；随机模式会重新随机，顺序发文会按当前进度和最新长度发送。
...
-选 <标题>：选择当前文章
-模式：查看当前发文模式
-字数 <10至2000的整数>：设置各种发文模式的每段字数或行数
